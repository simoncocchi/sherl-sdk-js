...
export const getPublicProduct = async (id: string): Promise<IPublicProductResponse> => {
...
export const getPublicProductBySlug = async (slug: string): Promise<IPublicProductResponse> => {
  let response: ApiResponse<IPublicProductResponse> | null = null;
